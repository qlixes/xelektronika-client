    ...
    for i:=0 to FJSONArray.Count-1 do begin
      ...
      for j:=0 to FJSONObject.Count-1 do //begin
        case FJSONObject.Names[j] of
          ...
          'discrp0','discrp1','ppnrp','biayarp0','biayarp1','totalbruto','totalppn','totaldisc','totalnetto', 'bayar', 'harga', 'hpp', 'totalhpp':FStrGrid.Cells[j, i+1]:=FormatCurr('#,##0.#0', FJSONObject.Items[j].AsFloat);
